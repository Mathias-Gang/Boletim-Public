...
<html lang="pt-BR">
    <head>
        <title>Entrar - Boletim ISERJ</title>
    ...
    <body>
        ...
        <form class="login" method="post" action="modules/auth/logar.php">
            <div>
                <div class="barraCima"></div>
                <h1 style="color: white; font-size: 24px;">Entrar no Boletim ISERJ</h1>
            </div>
            <div>
            ...
            <div>
                <label style="font-weight: 700;" for="email_inst" for="senha">Senha</label>
                <div class="entrada" id="senha_div" style="height: 36px; width: -webkit-fill-available; padding: 0; display: flex; align-items: center;">
                    <input id="senha" type="password" autocomplete="off" name="senha" required="required" placeholder="••••••••"/>
            ...
            <div style="align-items: center;">
                <input class="submit" type="submit" value="Entrar" disabled>
            </div>
...
<html lang="pt-BR">
    ...
    <body>
        ...
        <form class="login" method="post" action="modules/auth/logar.php">
            ...
            <label>
                Email
                <input class="entrada" id="email_inst" type="email" required="required" placeholder="conta@gmail.com"/>
            </label>
            <label>
                Senha
                <div class="entrada" id="senha_div" style="height: 36px; width: -webkit-fill-available; padding: 0; display: flex; align-items: center;">
                    <input id="senha" type="password" autocomplete="off" required="required" placeholder="••••••••"/>
                    <img class="mostrarSenha" id="but_eye" src="img/eye_visible.png">
                </div>
            </label>
            <div class="g-recaptcha" data-sitekey="6LfUsfMcAAAAAO8ROgp89AyGWD8OBTjtH9laS1zt"></div>
            <div style="align-items: center;">
                <input class="submit" type="submit" value="Entrar" disabled>
            </div>
            <a href="redefinir">Redefinir Senha</a>
