...
<html lang="pt-BR">
    <head>
        <title>Redefinir senha de <?php echo $email; ?> - Boletim ISERJ</title>
    ...
    <body>
        ...
        <form class="login" method="post" action="modules/auth/redefinirSenha.php">
            <input type="hidden" id="chave" name="chave" value="<?php echo $_GET["q"]; ?>">
            <div>
                <div class="barraCima"></div>
                <h1 style="color: white; font-size: 24px;">Redefinir senha de <?php echo $email; ?> no Boletim ISERJ</h1>
            </div>
            <div>
                <label style="font-weight: 700;" for="senha">Senha</label>
                <div class="entrada" id="senha_div" style="height: 36px; width: -webkit-fill-available; padding: 0; display: flex; align-items: center;">
                    <input class="senha" id="senha" type="password" autocomplete="off" name="senha" required="required" placeholder="••••••••"/>
                    <img class="mostrarSenha" id="but_eye" src="img/eye_visible.png">
                </div>
            </div>
            <div>
                <label style="font-weight: 700;" for="confirmarSenha">Confirmar senha</label>
                <div class="entrada" id="senha_div" style="height: 36px; width: -webkit-fill-available; padding: 0; display: flex; align-items: center;">
                    <input class="senha" id="confirmarSenha" type="password" autocomplete="off" name="confirmarSenha" required="required" placeholder="••••••••"/>
                    <img class="mostrarSenha" id="but_eye" src="img/eye_visible.png">
                </div>
            </div>
            ...
            <div style="align-items: center;">
                <input class="submit" type="submit" value="Redefinir senha" disabled>
            </div>
        </form>
    </body>
</html>